...
void notifications::notifications_ajouterPlat()
{
    ...
    notifyIcon->setIcon(QIcon("C:/Users/abdelmomen medhioub/Desktop/gets_palt_boisson/valider.png"));
  notifyIcon->show();
...
void notifications::notifications_supprimerPlat(){
    ...
    notifyIcon->setIcon(QIcon("C:/Users/abdelmomen medhioub/Desktop/gets_palt_boisson/supprimer.jpg"));
    notifyIcon->show();
...
void notifications::notifications_modifierPlat(){
   ...
   // notifyIcon->setIcon(QIcon("C:/Users/abdelmomen medhioub/Desktop/gets_palt_boisson/modifier.jpg"));
    notifyIcon->show();
